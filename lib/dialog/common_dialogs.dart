...
class CommonDialogs {
  showDeleteAccountAlertDialog(BuildContext context, String title, String msg,
      VoidCallback onTapYes, VoidCallback onTapCancel) {
    // set up the button
  ...
  showAlreadyExistDialog(BuildContext context, VoidCallback onTapYes) {
    // set up the button
    Widget okButton = TextButton(
      child: Text("Ok".allInCaps,
          style: textStyle(Colors.white, 18, 0.5, FontWeight.w600)),
      onPressed: () {
        //onTapYes();
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text(
          "Please Change device name, this name is already exist in database",
